        ...
        switch (v.getId()) {
            case R.id.btnSubmit:
                ...
                DatabaseHelper databaseHelper=new DatabaseHelper(this);
                       ...
                       new VerficationTask(MainActivity.this,mMobile.getText().toString(),mPassword.getText().toString(),VerficationTask.strDate,databaseHelper).execute( );
